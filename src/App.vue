...
body{
    background-color: rgb(252, 242, 113);
    color: rgb(12, 22, 58);
...
#main{
    ...
    border-radius: 10px;
    background-color: rgb(217, 219, 209);
}
.animation{
    padding: 25px 25px;
    margin: 15px auto;
...
.start:hover{
    ...
    box-shadow: inset  0px 5px 0px 0px rgb(255, 150, 0);
}
.playPause,.restart,.sh-b,.lg-b{
    margin: 2%;
    margin-top: 20px;
    padding: 10px;
    width: 45%;
...
.playPause:hover,.restart:hover,.sh-b:hover,.lg-b:hover{
    background-color: rgb(255, 170, 0);
    box-shadow: inset  0px 5px 0px 0px rgb(255, 150, 0);
}
.timer{
